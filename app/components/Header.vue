...
<template>
  <header
    class="sticky top-0 z-50 glass-header transition-shadow duration-300"
    :class="{ scrolled }"
  >
    <div class="max-w-5xl mx-auto flex items-center justify-between px-4 py-3">
      ...
      <div class="flex items-center gap-2 sm:gap-3">
        ...
        <a
          href="#contact"
          class="hidden sm:inline-flex px-4 py-2 border text-sm font-semibold transition-all duration-200 rounded-lg hover:scale-105 hover:shadow-lg"
