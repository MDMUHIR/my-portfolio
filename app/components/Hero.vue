...
<template>
  ...
  >
    <div class="absolute inset-0 opacity-[0.03] pointer-events-none">
      <div class="absolute top-20 left-10 w-72 h-72 rounded-full bg-accent blur-3xl"></div>
      <div class="absolute bottom-20 right-10 w-96 h-96 rounded-full bg-accent-light blur-3xl"></div>
    </div>
      ...
      <div v-else class="flex flex-col md:grid md:grid-cols-2 gap-10 md:gap-12 items-center">
        <div class="w-full">
          ...
          <div class="reveal stagger-1">
            <p class="text-theme-secondary text-lg sm:text-xl mb-2 font-semibold typing-cursor">&gt; {{ displayProfile.title }}</p>
          </div>
          ...
          <div class="reveal stagger-3 grid grid-cols-3 gap-3 sm:gap-4 mb-6 md:mb-8 py-5 sm:py-6 border-y border-theme">
            <div class="text-center sm:text-left">
              <div class="gradient-text-accent text-xl sm:text-2xl font-bold">{{ displayProfile.years_exp }}+</div>
              <div class="text-theme-secondary text-xs sm:text-sm">Years Exp</div>
            </div>
            <div class="text-center sm:text-left">
              <div class="gradient-text-accent text-xl sm:text-2xl font-bold">{{ displayProfile.projects_count }}+</div>
