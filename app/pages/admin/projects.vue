...
const saveItem = async () => {
  ...
  form.value.tags = tagsInput.value
    ...
    .map((t) => t.trim())
    .filter(Boolean);
  form.value.highlights = highlightsInput.value
    .split("\n")
    .map((h) => h.trim())
    .filter(Boolean);
...
<template>
  <div>
    ...
    >
      ...
      <button @click="openForm()" class="text-blue-600 hover:underline">
    ...
    >
      <div
        class="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6"
      >
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div class="flex gap-2">
                ...
                />
                <label
                  class="px-3 py-2 bg-gray-100 rounded-lg hover:bg-gray-200 cursor-pointer text-sm whitespace-nowrap flex items-center transition-colors"
                >
                  Browse
                  <input
                    type="file"
              ...
              <div v-if="form.image && !uploading" class="mt-2">
                <img
                  :src="form.image"
                  class="h-20 w-auto rounded-lg object-cover border"
                />
              </div>
            </div>
          </div>
